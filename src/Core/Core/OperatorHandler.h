...
public:
	...
	int m__id;
	// constructor
	element(char *ptr, bool delete_ptr=false, int id=-1) {
	    m__ptr = NULL;
	    m__delete_ptr = false;
	    m__id = id;
	}
