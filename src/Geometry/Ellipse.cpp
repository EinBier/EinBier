...
Ellipse::Ellipse(double xradius, double yradius, double x, double y):p_xradius(xradius), p_yradius(yradius)
{
  p_center.resize(2);
  p_center[0]=(x);
  p_center[1]=(y);
...
Ellipse::Ellipse(double xradius, double yradius, std::vector<double> center):p_xradius(xradius), p_yradius(yradius)
{
  if(center.size() != 2)
    {
...
bool Ellipse::Intersect(Ellipse *e)
{
  ...
  double dO1O2 = (p_center[0]-center[0])*(p_center[0]-center[0]) + (p_center[1]-center[1])*(p_center[1]-center[1]);
  dO1O2 = sqrt(dO1O2);
  //cosTheta
